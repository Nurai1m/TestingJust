...
namespace EducationSystem.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Time,TeacherId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Time,TeacherId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
